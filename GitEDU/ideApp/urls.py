...
urlpatterns = [
    ...
    url(r'^new/repository/$', views.NewFullRepositoryView.as_view(), name="new_full_repository"),  # TODO: pymodm bug
                                                                                                   # TODO: when repo
                                                                                                   # TODO: name exists
                                                                                                   # TODO: in a
                                                                                                   # TODO: different
    ...
    url(r'execute/status/(?P<job_id>[a-zA-Z0-9-]*)/', views.ExecutionStatusView.as_view(),
        name='execution-status'),
    url(r'execute/result/(?P<job_id>[a-zA-Z0-9-]*)/', views.ExecutionResultView.as_view(),
